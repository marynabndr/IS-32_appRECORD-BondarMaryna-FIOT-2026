...
**Мета роботи:** розробити адаптивний веб-застосунок для школи іноземних мов, який забезпечує інформаційну підтримку клієнтів та автоматизацію збору заявок на навчання.
...
**Об’єкт роботи:** веб-застосунок для автоматизації діяльності школи іноземних мов.
...
## Use-case діаграма
### Актори системи
- Гість (Відвідувач) - неавторизований користувач, який шукає інформацію.

- Клієнт (Студент) - особа, яка вже зацікавлена та взаємодіє з формами зворотного зв'язку.

- Адміністратор (Менеджер) - внутрішній користувач, який опрацьовує результати роботи сайту.
...
![Скрін 2](/assets/labs/lab-1/er-diagram.jpg)
